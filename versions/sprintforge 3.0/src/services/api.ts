...
export const api = {
  ...
  auth: {
    ...
    updateProfile: (data: { name?: string; phone?: string; techArea?: string }) =>
  ...
  projects: {
    ...
    create: (projectData: { name: string; description: string; activeMethodology: string; teamSize: number; tags?: string[] }) =>
